...
export const login = async (req, res) => {
    ...
    try {
        ...
        console.log("Login error controller:", error.stack);
        res.status(500).json({ message: "Internal server error" });
    }
};
...
export const updateProfile = async (req, res) => {
    try {
        ...
        console.log("Update profile error controller:", error.stack);
        res.status(500).json({ message: "Internal server error" });
    }
};
...
export const checkAuth = (req, res) => {
    try {
        ...
        console.log("Check auth error controller:", error.stack);
        res.status(500).json({ message: "Internal server error" });
    }
};